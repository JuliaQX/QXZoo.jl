...
struct GateCall1 <: AGateCall
    gate_label::AGateSymbol
    target::Integer
    reg::Union{String, Nothing}
    GateCall1(gate_label, target, reg) = new(gate_label, target, reg)
    GateCall1(gate_label, target) = new(gate_label, target, nothing)
end
...
struct GateCall2 <: AGateCall
    ...
    GateCall2(gate_label, ctrl, target, base_gate, reg) = 
    new(gate_label, ctrl, target, base_gate, reg)

    GateCall2(gate_label, ctrl, target, base_gate) = 
    new(gate_label, ctrl, target, base_gate, nothing)

    GateCall2(gate_label, ctrl, target) = 
...
struct GateCallN <: AGateCall
    ...
    GateCallN(gate_label, ctrl, target, base_gate, reg) = 
    new(gate_label, ctrl, target, base_gate, reg)

    GateCallN(gate_label, ctrl, target, base_gate) = 
    new(gate_label, ctrl, target, base_gate, nothing)

    GateCallN(gate_label, ctrl, target) = 
    new(gate_label, ctrl, target, nothing, nothing)
end
